        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="applyBtn" disabled="disabled">' + this.locale.applyLabel + '</button>' +
                    '&nbsp;<button class="cancelBtn">' + this.locale.cancelLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        clickDate: function (e) {
            ...
            if (cal.hasClass('left')) {
                ...
                var maxDate = startDate.clone().addDays(this.dateLimit.days);
                ...
                var minDate = endDate.clone().addDays(-1 * this.dateLimit.days);
