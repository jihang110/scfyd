...
public class PayCommitProcessReqBean extends BaseReqBean{
	...
	public String getGuaranteeDiff() {
		return guaranteeDiff;
	}

	public void setGuaranteeDiff(String guaranteeDiff) {
		this.guaranteeDiff = guaranteeDiff;
	}
